...
public class O109_BrokenLinks {
	...
	public static void main(String[] args) throws MalformedURLException, IOException, InterruptedException {
		...
		// Add SoftAssert. The check will not stop after found the first non-working link. It will check all the links and throw the broken links as an Exception.
		...
		for (WebElement link : page_links) {
			...
			// if you don't need the SoftAssert and need to stop the iteration after you find the first non-working link, than use this code.
//			if (resp_code > 400) {
